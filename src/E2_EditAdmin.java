...
/**
 * A class which allows the employees to alter the information of the Administrator database
 * This allows the employees to create, update, search or delete an Administrator
...
public class E2_EditAdmin extends JFrame {
    ...
    /**
     * A constructor which creates the GUI frame of Admin for the Manager
